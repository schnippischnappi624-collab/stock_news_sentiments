...
| **Current price** | `163.60 SEK (15.10 EUR)` |
| **Prior 20d high trigger** | `162.40 SEK (14.99 EUR)` |
...
## What Matters
- Price is holding above the prior 20-day high (162.40), a basic breakout confirmation signal. (high)
- Price is above EMA20, EMA50, EMA200, which keeps the medium-term trend supportive. (medium)

## Risks / Invalidation
- A close back below 162.40 would weaken or invalidate the current breakout picture. (high)
- The name is still only a candidate in the source feed, so the setup is not fully confirmed yet. (medium)

## Catalysts
- The next 1 to 4 weeks matter most around whether price can keep holding above 162.40 and attract follow-through volume. (medium)
...
## Key Levels
- Volume anomaly: `1.57017030078811`
- Close: `163.6`
- Prior 20d high: `162.4`
- ATR14: `4.81356370818324`

## Why This Score
- Base breakout score: `+40`
- Price is holding above the 20-day high trigger: `+7` (value: `0.74`)
- Name is still a candidate, not confirmed ENTRY_READY: `-4`
- Price is above EMA20: `+3` (value: `8.11`)
