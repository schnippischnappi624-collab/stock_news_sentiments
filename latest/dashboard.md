...
- Run ID: `2026-06-12_eu_992afe45`
- Prior regional run: `2026-06-11_eu_74fd4c6b`
- Feed dates: `2026-06-11, 2026-06-12`
- Symbols analyzed: `0`
...
- Run ID: `2026-06-12_us_14527331`
- Prior regional run: `2026-06-11_us_50c175eb`
- Feed dates: `2026-06-10, 2026-06-12`
- Symbols analyzed: `0`
- Sort mode: sections `Entry Ready Near Trigger -> Entry Ready But Already Spiked -> Candidates`; in-section rank = `score desc -> confidence desc -> abs(distance to entry) asc -> symbol asc`; near-trigger cutoff = `5%`
