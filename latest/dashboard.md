...
- Run ID: `2026-07-10_eu_2f2e326c`
- Prior regional run: `2026-07-09_eu_752156f6`
- Feed dates: `2026-06-29, 2026-07-10`
- Symbols analyzed: `0`
...
- Run ID: `2026-07-09_us_1ca7a814`
- Prior regional run: `2026-07-08_us_b9e98f82`
- Feed dates: `2026-07-03, 2026-07-09`
- Symbols analyzed: `0`
- Sort mode: sections `Entry Ready Near Trigger -> Entry Ready But Already Spiked -> Candidates`; in-section rank = `score desc -> confidence desc -> abs(distance to entry) asc -> symbol asc`; near-trigger cutoff = `5%`
