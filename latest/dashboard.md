...
- Run ID: `2026-09-02_eu_02a98ee7`
- Prior regional run: `2026-09-01_eu_e23afddb`
- Feed dates: `2026-06-29, 2026-09-02`
- Symbols analyzed: `0`
...
- Run ID: `2026-09-01_us_6ff18e33`
- Prior regional run: `2026-08-31_us_c7ad2de5`
- Feed dates: `2026-07-03, 2026-09-01`
- Symbols analyzed: `0`
- Sort mode: sections `Entry Ready Near Trigger -> Entry Ready But Already Spiked -> Candidates`; in-section rank = `score desc -> confidence desc -> abs(distance to entry) asc -> symbol asc`; near-trigger cutoff = `5%`
