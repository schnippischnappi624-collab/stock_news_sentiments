...
- Run ID: `2026-08-02_eu_124fd1ac`
- Prior regional run: `2026-08-01_eu_7a167ad1`
- Feed dates: `2026-06-29, 2026-08-02`
- Symbols analyzed: `0`
...
- Run ID: `2026-08-01_us_ad47718c`
- Prior regional run: `2026-07-31_us_5f00a8dd`
- Feed dates: `2026-07-03, 2026-08-01`
- Symbols analyzed: `0`
- Sort mode: sections `Entry Ready Near Trigger -> Entry Ready But Already Spiked -> Candidates`; in-section rank = `score desc -> confidence desc -> abs(distance to entry) asc -> symbol asc`; near-trigger cutoff = `5%`
