...
- Run ID: `2026-08-26_eu_bef97cec`
- Prior regional run: `2026-08-25_eu_675841a5`
- Feed dates: `2026-06-29, 2026-08-26`
- Symbols analyzed: `0`
...
- Run ID: `2026-08-26_us_8d80d59d`
- Prior regional run: `2026-08-25_us_e88a2c3e`
- Feed dates: `2026-07-03, 2026-08-26`
- Symbols analyzed: `0`
- Sort mode: sections `Entry Ready Near Trigger -> Entry Ready But Already Spiked -> Candidates`; in-section rank = `score desc -> confidence desc -> abs(distance to entry) asc -> symbol asc`; near-trigger cutoff = `5%`
