...
- Run ID: `2026-05-18_eu_bdf97585`
- Prior regional run: `2026-05-17_eu_96557441`
- Feed dates: `2026-05-15, 2026-05-18`
- Symbols analyzed: `0`
...
- Run ID: `2026-05-17_us_ea1b27d2`
- Prior regional run: `2026-05-16_us_bfab3cb6`
- Feed dates: `2026-05-15, 2026-05-17`
- Symbols analyzed: `0`
- Sort mode: sections `Entry Ready Near Trigger -> Entry Ready But Already Spiked -> Candidates`; in-section rank = `score desc -> confidence desc -> abs(distance to entry) asc -> symbol asc`; near-trigger cutoff = `5%`
