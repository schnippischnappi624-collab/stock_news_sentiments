...
- Run ID: `2026-07-16_eu_52a63102`
- Prior regional run: `2026-07-15_eu_0b3a7eef`
- Feed dates: `2026-06-29, 2026-07-16`
- Symbols analyzed: `0`
...
- Run ID: `2026-07-15_us_147bab67`
- Prior regional run: `2026-07-14_us_501ea3b6`
- Feed dates: `2026-07-03, 2026-07-15`
- Symbols analyzed: `0`
- Sort mode: sections `Entry Ready Near Trigger -> Entry Ready But Already Spiked -> Candidates`; in-section rank = `score desc -> confidence desc -> abs(distance to entry) asc -> symbol asc`; near-trigger cutoff = `5%`
