...
- Run ID: `2026-06-17_eu_f5f6b7c6`
- Prior regional run: `2026-06-16_eu_89798984`
- Feed dates: `2026-06-11, 2026-06-17`
- Symbols analyzed: `0`
...
- Run ID: `2026-06-17_us_0a73d0ff`
- Prior regional run: `2026-06-16_us_31713bce`
- Feed dates: `2026-06-10, 2026-06-17`
- Symbols analyzed: `0`
- Sort mode: sections `Entry Ready Near Trigger -> Entry Ready But Already Spiked -> Candidates`; in-section rank = `score desc -> confidence desc -> abs(distance to entry) asc -> symbol asc`; near-trigger cutoff = `5%`
