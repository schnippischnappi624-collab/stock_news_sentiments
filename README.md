...
- Feed dates: `2026-06-29, 2026-07-01, 2026-07-02`
- Symbols analyzed: `2`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [GALDY](<latest/us/analysis/markdown/GALDY.md>) | GALDERMA GROUP AG | $\color{#1a7f37}{\textsf{+0.05\%}}$ | $\color{#1a7f37}{\textsf{entry ready}}$ | $\color{#9a6700}{\textsf{70}}$ | $\color{#1a7f37}{\textsf{high}}$ | $\color{#2da44e}{\textsf{constructive watch}}$ | $\color{#9a6700}{\textsf{mixed}}$ | $\color{#1a7f37}{\textsf{strong(15)}}$ |
