...
| 3 | [EPEN](<latest/eu/analysis/markdown/EPEN.md>) | Ependion AB | $\color{#1a7f37}{\textsf{+0.36\%}}$ | $\color{#1a7f37}{\textsf{entry ready}}$ | $\color{#9a6700}{\textsf{60}}$ | $\color{#9a6700}{\textsf{medium}}$ | $\color{#2da44e}{\textsf{constructive watch}}$ | $\color{#9a6700}{\textsf{mixed}}$ | $\color{#2da44e}{\textsf{good(3)}}$ |
...
| 2 | [SFQ](<latest/eu/analysis/markdown/SFQ.md>) | SAF Holland SA | $\color{#cf222e}{\textsf{+5.26\%}}$ | $\color{#1a7f37}{\textsf{entry ready}}$ | $\color{#9a6700}{\textsf{72}}$ | $\color{#1a7f37}{\textsf{high}}$ | $\color{#2da44e}{\textsf{constructive watch}}$ | $\color{#cf222e}{\textsf{conflicting}}$ | $\color{#1a7f37}{\textsf{strong(9)}}$ |
