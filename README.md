...
- Feed dates: `2026-06-25, 2026-06-26`
- Symbols analyzed: `2`
...
- Run ID: `2026-06-26_eu_266dc23c`
- Prior regional run: `2026-06-25_eu_ee3f86b4`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | [GALDY](<latest/us/analysis/markdown/GALDY.md>) | GALDERMA GROUP AG | $\color{#1a7f37}{\textsf{+0.05\%}}$ | $\color{#1a7f37}{\textsf{entry ready}}$ | $\color{#1a7f37}{\textsf{81}}$ | $\color{#1a7f37}{\textsf{high}}$ | $\color{#1a7f37}{\textsf{constructive bullish}}$ | $\color{#1a7f37}{\textsf{supportive}}$ | $\color{#1a7f37}{\textsf{strong(5)}}$ |
