...
<tr><td><strong>Distance to entry limit</strong></td><td><span style="color:#1a7f37"><code>0.05 EUR / +0.50% above limit</code></span></td></tr>
...
## What Matters
- Price is holding above the prior 20-day high (9.05), a basic breakout confirmation signal. (high)
- Volume anomaly is strong at 2.24, which supports the move. (high)

## Risks / Invalidation
- A close back below 9.05 would weaken or invalidate the current breakout picture. (high)
- Broader market headwind remains relevant (Middle East conflict / defense tailwind): 2026-04-13: Dow futures fall 450 points after Trump announces Strait of Hormuz blockade as talks fail: Live updates - CNBC. (medium)

## Catalysts
- The next 1 to 4 weeks matter most around whether price can keep holding above 9.05 and attract follow-through volume. (medium)
