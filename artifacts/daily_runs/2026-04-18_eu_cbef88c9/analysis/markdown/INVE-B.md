# INVE-B - Investor AB ser. B

- Quote: [Investing.com (INVE-B)](<https://de.investing.com/search/?q=INVE-B%20Investor%20AB%20ser.%20B>)
...
## What Matters
- Price is holding above the prior 20-day high (378.70), a basic breakout confirmation signal. (high)
- Price is above EMA20, EMA50, EMA200, which keeps the medium-term trend supportive. (medium)

## Risks / Invalidation
- A close back below 378.70 would weaken or invalidate the current breakout picture. (high)
- The name is still only a candidate in the source feed, so the setup is not fully confirmed yet. (medium)

## Catalysts
- The next 1 to 4 weeks matter most around whether price can keep holding above 378.70 and attract follow-through volume. (medium)
...
## Key Levels
- Volume anomaly: `1.45589322178796`
- Close: `385.6`
- Prior 20d high: `378.7`
- ATR14: `7.78775302812055`
...
- Price is above EMA20: `+3` (value: `5.53`)
